\begin{frame}{Algoritmeanalyse}
    \begin{block}{Må øves på}
        ...
        \begin{itemize}
            \item Best-case, da antar vi noe om hvordan problem-instansene ser ut, utover størrelsen på data-en
            \item Worst-case, igjen vi antar noe om problem-instansene
            ...
            \item Amortisert analyse: Da ser vi på gjennomsnitt av kjøretiden over flere kall av algoritmen, men vi antar ingenting om problem-instansen. Eksempel
        \end{itemize}
    \end{block}
\end{frame}
